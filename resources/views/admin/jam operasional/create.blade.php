...
<div class="min-h-screen bg-[#f8fafc] relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="reveal reveal-delay-1">
            ...
            <h1 class="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Tambah Jam Operasional</h1>
            <p class="text-gray-500 text-sm mt-1">Buat jadwal pelayanan PPDB baru</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden reveal reveal-delay-2">
            ...
            <form action="{{ route('admin.jam_operasional.store') }}" method="POST" class="p-6 md:p-8 lg:p-10">
                @csrf
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="hari" value="{{ old('hari') }}" required placeholder="Contoh: Senin - Jumat"
