...
<div class="min-h-screen bg-[#f8fafc] relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="reveal reveal-delay-1 mb-6">
            ...
            <h1 class="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Tambah Foto Baru</h1>
            <p class="text-gray-500 text-sm mt-1">Upload foto kegiatan dan fasilitas sekolah</p>
        </div>
        ...
        <div class="w-full reveal reveal-delay-2">
            <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            <div class="border-2 border-dashed border-gray-300 rounded-2xl p-6 text-center hover:border-blue-400 hover:bg-blue-50/30 transition-all cursor-pointer" onclick="document.getElementById('gambarInput').click()">
                                <input type="file" id="gambarInput" name="gambar" accept="image/*" required class="hidden" onchange="previewImage(this, 'gambarPreview')">
                                ...
                                <p class="text-xs text-gray-500 mb-1">Klik untuk upload gambar</p>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="album" placeholder="Contoh: Kegiatan, Prestasi, Fasilitas..."
                                   class="w-full pl-10 pr-4 py-2.5 bg-gray-50/80 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none placeholder:text-gray-400">
                        </div>
                        <p class="text-[10px] text-gray-400 mt-1">Gunakan untuk mengelompokkan foto</p>
                    </div>
