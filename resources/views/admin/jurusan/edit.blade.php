...
<div class="min-h-screen bg-[#f8fafc] relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="reveal reveal-delay-1">
            ...
            <h1 class="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Edit Jurusan</h1>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden reveal reveal-delay-2">
            ...
            <form action="{{ route('admin.jurusan.update', $jurusan) }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 lg:p-10">
                @csrf
                @method('PUT')
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="kode" value="{{ old('kode', $jurusan->kode) }}" required placeholder="Contoh: RPL"
                                ...
                                @error('kode') <p class="text-rose-500 text-xs mt-1.5">{{ $message }}</p> @enderror
                            </div>
                            <div>
                                <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" name="nama" value="{{ old('nama', $jurusan->nama) }}" required placeholder="Rekayasa Perangkat Lunak"
                                           class="w-full pl-10 pr-4 py-2.5 bg-gray-50/80 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none placeholder:text-gray-400">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <textarea name="deskripsi" rows="5" placeholder="Deskripsi singkat tentang jurusan ini..."
                                          class="w-full pl-10 pr-4 py-2.5 bg-gray-50/80 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none resize-none placeholder:text-gray-400">{{ old('deskripsi', $jurusan->deskripsi) }}</textarea>
                            </div>
                        ...
                        <div class="max-w-xs">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="kuota" value="{{ old('kuota', $jurusan->kuota) }}" required min="1"
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gray-50/80 border border-gray-100 max-w-md">
                            <div class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="is_active" id="is_active" value="1" {{ $jurusan->is_active ? 'checked' : '' }} class="sr-only peer">
                        ...
                        <div class="space-y-4">
                            ...
                            <div id="current-image" class="relative">
                                <div class="aspect-[4/3] rounded-2xl overflow-hidden border border-gray-200 bg-gray-100">
                                    <img src="{{ Storage::url($jurusan->gambar) }}" class="w-full h-full object-cover" alt="{{ $jurusan->nama }}">
                                </div>
                            ...
                            <div class="relative border-2 border-dashed border-gray-200 rounded-2xl p-6 text-center hover:border-blue-300 hover:bg-blue-50/30 transition-all cursor-pointer group" onclick="document.getElementById('gambar').click()">
                                ...
                                <p class="text-xs text-gray-400 mt-1.5">JPG, PNG • Maks 2MB</p>
                            </div>
