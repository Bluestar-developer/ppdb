...
<div class="min-h-screen bg-[#f8fafc] relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <!-- Back Navigation -->
        <div class="reveal">
            <a href="{{ route('admin.jadwal.index') }}" class="group inline-flex items-center gap-2 text-sm text-gray-500 hover:text-blue-600 transition-colors">
                ...
                <span class="font-medium">Kembali ke Jadwal PPDB</span>
            </a>
        </div>
        ...
        <div class="reveal reveal-delay-1">
            ...
            <h1 class="text-2xl md:text-3xl font-black text-gray-900 tracking-tight">Edit Jadwal</h1>
            <p class="text-gray-500 text-sm mt-1">Perbarui agenda kegiatan: {{ $jadwal->nama_kegiatan }}</p>
        </div>
        ...
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden reveal reveal-delay-2">
            ...
            <form action="{{ route('admin.jadwal.update', $jadwal) }}" method="POST" class="p-6 md:p-8 lg:p-10">
                @csrf
                @method('PUT')
                ...
                <div class="max-w-3xl space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nama_kegiatan" value="{{ $jadwal->nama_kegiatan }}" required placeholder="Masukkan nama kegiatan..."
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="tanggal_mulai" value="{{ $jadwal->tanggal_mulai->format('Y-m-d') }}" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="tanggal_selesai" value="{{ $jadwal->tanggal_selesai->format('Y-m-d') }}" required
                                       class="w-full pl-10 pr-4 py-2.5 bg-gray-50/80 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Keterangan -->
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Keterangan</label>
                        <div class="relative">
                            ...
                            <textarea name="keterangan" rows="5" placeholder="Deskripsi singkat tentang kegiatan ini..."
                                      class="w-full pl-10 pr-4 py-2.5 bg-gray-50/80 border border-gray-200 rounded-xl text-sm focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none resize-none placeholder:text-gray-400">{{ $jadwal->keterangan }}</textarea>
                        </div>
                        <p class="text-xs text-gray-400 mt-1.5">Informasi tambahan mengenai kegiatan (opsional)</p>
                    </div>
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="{{ route('admin.jadwal.index') }}" class="btn-outline-premium">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
